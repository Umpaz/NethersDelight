...
public class RichSoulSoilBlock extends Block
{
    ...
    public void randomTick(BlockState state, ServerLevel worldIn, BlockPos pos, RandomSource rand) {
        if (!worldIn.isClientSide) {
            ...
            if (aboveBlock instanceof BonemealableBlock growable && (aboveBlock instanceof TwistingVinesBlock || aboveBlock instanceof TwistingVinesPlantBlock) && MathUtils.RAND.nextFloat() <= Configuration.RICH_SOIL_BOOST_CHANCE.get() - 0.8F) {
            ...
            if (belowBlock instanceof BonemealableBlock growable && (belowBlock instanceof WeepingVinesBlock || belowBlock instanceof WeepingVinesPlantBlock) && MathUtils.RAND.nextFloat() <= Configuration.RICH_SOIL_BOOST_CHANCE.get() - 0.5) {
            ...
            if (aboveBlock == Blocks.NETHER_WART && MathUtils.RAND.nextFloat() <= Configuration.RICH_SOIL_BOOST_CHANCE.get() - 0.2F) {
